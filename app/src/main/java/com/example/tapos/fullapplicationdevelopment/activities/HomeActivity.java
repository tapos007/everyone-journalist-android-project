...
import com.example.tapos.fullapplicationdevelopment.fragments.MessageFragment;
import com.example.tapos.fullapplicationdevelopment.fragments.ProfileFragment;
...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG,SharedPrefManager.getInstance(this).getUser().getEmail());
